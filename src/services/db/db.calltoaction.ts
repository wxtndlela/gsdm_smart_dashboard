...
export class Calltoaction {
    private dbPath = '/calltoaction';
    public Calltoaction: BehaviorSubject<Object>;
    ...
    constructor(
        ...
        this.Calltoaction = new BehaviorSubject<Object[]>([]);
    }
        ...
        this.Ref.snapshotChanges().pipe(
            map(changes =>
                ...
                ({
                    ...
                    call_type: c.payload.doc.data().call_type,
                    call_url: c.payload.doc.data().call_url,
            ...
            //console.log(data)
            this.Calltoaction.next(data);
        });
    }

    async getCalltoactions(user_id){
        let Data = [];
    ...
    async create(calltoaction: CalltoactionModal): Promise<any> {
        const id = this.db.createId();
        return this.Ref.doc(id).set(calltoaction);
    }

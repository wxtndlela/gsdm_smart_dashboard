...
const enableScrollAssist = (componentEl, inputEl, contentEl, footerEl, keyboardHeight) => {
  ...
  const touchEnd = (ev) => {
    ...
    const endCoord = Object(_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__["p"])(ev);
...
const jsSetFocus = async (componentEl, inputEl, contentEl, footerEl, keyboardHeight) => {
   ...
   */
  Object(_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__["r"])(() => componentEl.click());
...
const startInputShims = (config) => {
  ...
  const registerInput = async (componentEl) => {
    await new Promise(resolve => Object(_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__["c"])(componentEl, resolve));
...
//# sourceMappingURL=input-shims-ce03ee9f-js-es2015.js.map
...
const startTapClick = (config) => {
  ...
  const onMouseDown = (ev) => {
    const t = Object(_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__["q"])(ev) - MOUSE_WAIT;
    if (lastTouch < t) {
      pointerDown(ev);
    }
  };
  ...
  const setActivatedElement = (el, ev) => {
    ...
    clearTimeout(activeDefer);
    activeDefer = undefined;
    const { x, y } = Object(_helpers_1457892a_js__WEBPACK_IMPORTED_MODULE_0__["p"])(ev);
    // deactivate selected
    if (activatableEle) {
